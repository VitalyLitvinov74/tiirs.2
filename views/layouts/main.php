        ...
        <ul class="list-unstyled topbar-nav float-right mb-0">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="<?= \yii\helpers\Url::toRoute(['auth/login']) ?>"><i
                                class="ti-power-off text-muted mr-2"></i> Выход</a>
                </div>
            </li>
        </ul><!--end topbar-nav-->
...
<div class="left-sidenav">
    ...
    <ul class="metismenu left-sidenav-menu">
        ...
        <li class="<?=$currentRoute == $item['route'] ? " mm-active  active": ""?>">
            <a href="<?= Url::toRoute([$item['route']]) ?>"><i class="<?=$item['icon']?>"></i><span><?=$item['label']?></span></a>
        </li>

        <?php endforeach;?>
<!--        <li class="--><?//= $currentRoute == 'tasks/list' ? " mm-active  active" : "" ?><!--">-->
...
<div class="page-wrapper">
    ...
    <div class="page-content">
        ...
        <footer class="footer text-center text-sm-left">
            &copy; 2021 ООО "Челябинский Иновационный Центр"
